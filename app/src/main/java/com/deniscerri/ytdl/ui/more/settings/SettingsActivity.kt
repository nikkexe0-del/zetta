...
class SettingsActivity : BaseActivity(), SettingHost {
    ...
    private val sectionToNavId = mapOf(
        "appearance" to R.id.appearanceSettingsFragment,
        "folders" to R.id.folderSettingsFragment,
        "downloading" to R.id.downloadSettingsFragment,
        "processing" to R.id.processingSettingsFragment,
        "updating" to R.id.updateSettingsFragment,
        "advanced" to R.id.advancedSettingsFragment,
    )
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            // zetta: the Settings tab lists every section, so it can deep link straight into one
            sectionToNavId[intent.getStringExtra("section")]?.let { navController.navigate(it) }
        }
