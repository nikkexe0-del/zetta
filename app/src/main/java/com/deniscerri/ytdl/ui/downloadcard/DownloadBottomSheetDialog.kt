...
class DownloadBottomSheetDialog : BottomSheetDialogFragment() {
    ...
    override fun setupDialog(dialog: Dialog, style: Int) {
        ...
        // zetta: the audio/video/command tab strip is hidden, so swiping between pages would strand
        // the user on a page with no way back. Pin the pager to whichever type was selected.
